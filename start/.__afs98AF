{
  ...
  Plotter.setEffDirectory("Efficiencies_Selection_2j1b60");

  Plotter.setStylePath("/afs/cern.ch/user/a/akusurma/private/test/AtlasStyle.C");
  Plotter.setStyle(1);
...
//  TString type = "mu";
  ...
  Plotter.setOutDir("/afs/cern.ch/user/a/akusurma/private/test");
